 ...
 * Debito Automatico
 */
class WC_Debito_Automatico_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->id                   = 'debito-automatico';
		$this->icon                 = false;
		$this->has_fields           = true;
		$this->method_title         = 'Débito Automático';
		$this->method_description   = 'Aceita débito automático de todos os bancos.';
		$this->view_transaction_url = 'https://intermedsaude.online';
